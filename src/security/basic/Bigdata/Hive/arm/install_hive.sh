...
# ARM 架构特定配置
export HADOOP_OPTS="\${HADOOP_OPTS} -XX:+UseG1GC -XX:+UnlockExperimentalVMOptions"
export HIVE_OPTS="\${HIVE_OPTS} -XX:+UseG1GC -XX:+UnlockExperimentalVMOptions"
EOF
