...
-- 插入测试数据
INSERT INTO TABLE percona1 VALUES
...
-- 批量插入数据方式二：从本地文件加载数据
-- 假设数据文件为 percona1.txt，内容格式如下：
-- 1006,钱八,29,技术部,16000.00,2023-06-01
-- 1007,周九,31,市场部,13000.00,2023-07-15
-- LOAD DATA LOCAL INPATH '/path/to/percona1.txt' INTO TABLE percona1;

-- 查询验证数据
SELECT * FROM percona1;
-- SELECT count(1) FROM percona1;