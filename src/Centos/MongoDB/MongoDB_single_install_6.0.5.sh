...
# MongoDB 6.0.5 单机一键安装脚本 for CentOS 7.9
# 使用本地安装包：/tmp/mongodb-linux-x86_64-rhel70-6.0.5.tgz
...
# 安装参数配置
MONGO_VERSION="6.0.5"
MONGO_PACKAGE="/tmp/mongodb-linux-x86_64-rhel70-6.0.5.tgz"
