...
# MongoDB 5.0.9 单机一键安装脚本 for CentOS 7.9
# 使用本地安装包：/tmp/mongodb-linux-x86_64-rhel70-5.0.9.tgz
# 安装路径：/data/mongodb509
# 管理员密码：Secsmart#612
# 允许远程连接，安装连接工具，测试连接
# 创建时间：2023年
# 作者：DeepSeek AI
...
# 安装参数配置
MONGO_VERSION="5.0.9"
MONGO_PACKAGE="/tmp/mongodb-linux-x86_64-rhel70-5.0.9.tgz"
MONGO_BASE_DIR="/data/mongodb509"
...
if [ "${STATUS}" = "active" ]; then
    ...
    echo -e "\n\033[32m安装完成！MongoDB 5.0.9 已在 ${MONGO_BASE_DIR} 成功安装并运行。\033[0m"
