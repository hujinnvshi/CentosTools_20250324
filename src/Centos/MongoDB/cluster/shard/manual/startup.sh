...
/data/mongo_cluster_7.0.12/bin/mongos -f /data/mongo_cluster_7.0.12/config/mongos.conf &

/data/mongo_cluster_7.0.12/bin/mongod --config /data/mongo_cluster_7.0.12/data/config1/mongod.conf
